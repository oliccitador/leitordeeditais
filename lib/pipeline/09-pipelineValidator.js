...
class PipelineValidator {
    ...
    validateBasicStructure(corpo) {
        ...
        // ✅ FIX: Validar fullText (fonte canônica) com fallback para textoCompleto
        const textoCanon = corpo.fullText || corpo.textoCompleto;
        if (!textoCanon) errors.push('fullText/textoCompleto ausente');
        ...
        // ✅ FIX: Validar usando textoCanon
        if (textoCanon && textoCanon.length === 0) {
            warnings.push('fullText/textoCompleto vazio');
        }
