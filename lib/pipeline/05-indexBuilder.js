...
class IndexBuilder {
    ...
    async build(normalizedDoc) {
        try {
            ...
            // 🔍 DEBUG: Log entrada IndexBuilder (console + arquivo)
            ...
            // 🔍 DEBUG: Log SAÍDA IndexBuilder (rastrear keys)
            ...
            const dbg2 = (tag, obj) => {
                ...
                console.log(logLine);
                try {
                    fs2.appendFileSync(path2.join(process.cwd(), 'debug-ocr-pipeline.log'), logLine + '\n');
                } catch (e) { /* ignore */ }
            };
            dbg2('[05-OUT]', {
                id: normalizedDoc.documentId,
